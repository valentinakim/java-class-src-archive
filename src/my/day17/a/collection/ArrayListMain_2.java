...
public class ArrayListMain_2 {
	...
	public static void main(String[] args) {
		...
		//ArrayList는 데이터값이 동일한객체를 저장할 수 있다 메모리주소는 다르기 때문에
		
		mbrList.add(new Member("leess","qwer1234$","이순신"));
		
		//3.mbrList에 저장되어진 모든 회원들의 정보를 출력하도록 Member 클래스에 정의된 mbrInfo() 메소드를 실행하세요.
		//ArrayList mbrList에 저장되어진 데이터의 개수는 mbrList.size()로 알아온다.
	...
	// *** ArrayList 타입인 mbrList 에 새로운 Member 객체 추가시 특정 index(위치)에 들어가도록 할 수 있다.
