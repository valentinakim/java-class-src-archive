...
public class MainAnnonymous {
	...
	public static void main(String[] args) {
	   ...
	   */
		...
		};	//InterArea 클래스 선언과 동시에 객체를 만드는것.
		
		
		double areaSize3 = areaObj.area(10.5, 5.5);
		System.out.println("가로 10.5, 세로 5.5인 면적 : "+areaSize3);
